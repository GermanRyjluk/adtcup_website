...
import { 
  MapPin, Trophy, Users, Building2, Map, Compass, Building,
  Landmark, Mountain, ParkingCircle, Factory, 
  TreePine, Tent
} from 'lucide-react';
    ...
    <div className="relative min-h-screen bg-gradient-to-b from-[#1B4D98] to-blue-900 pt-16 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-20 left-10 bounce-stagger-1">
          <Building2 size={64} className="text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]" strokeWidth={0.5} />
        </div>
        <div className="absolute top-1/4 right-1/6 bounce-stagger-2">
          <Building size={72} className="text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]" strokeWidth={0.5} />
        </div>
        <div className="absolute bottom-1/3 left-1/5 bounce-stagger-3">
          <Building2 size={56} className="text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]" strokeWidth={0.5} />
        </div>

        {/* Layer 2 - Middle */}
        <div className="absolute top-40 right-20 bounce-stagger-4">
          <Map size={48} className="text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]" strokeWidth={0.5} />
        </div>
        <div className="absolute bottom-40 left-1/4 bounce-stagger-5">
          <Compass size={32} className="text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]" strokeWidth={0.5} />
        </div>
        <div className="absolute top-1/3 right-1/4 bounce-stagger-1">
          <Landmark size={64} className="text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]" strokeWidth={0.5} />
        </div>
        <div className="absolute bottom-1/4 left-1/3 bounce-stagger-2">
          <Mountain size={52} className="text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]" strokeWidth={0.5} />
        </div>

        {/* Layer 3 - Front */}
        <div className="absolute top-1/2 right-1/3 bounce-stagger-3">
          <ParkingCircle size={36} className="text-white drop-shadow-[0_0_25px_rgba(255,255,255,0.6)]" strokeWidth={0.5} />
        </div>
        <div className="absolute bottom-1/3 right-1/4 bounce-stagger-4">
          <Building size={48} className="text-white drop-shadow-[0_0_25px_rgba(255,255,255,0.6)]" strokeWidth={0.5} />
        </div>
        <div className="absolute top-2/3 left-1/4 bounce-stagger-5">
          <Factory size={44} className="text-white drop-shadow-[0_0_25px_rgba(255,255,255,0.6)]" strokeWidth={0.5} />
        </div>

        {/* Additional scattered elements */}
        <div className="absolute top-1/4 left-1/6 bounce-stagger-1">
          <TreePine size={28} className="text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]" strokeWidth={0.5} />
        </div>
        <div className="absolute bottom-1/4 right-1/5 bounce-stagger-2">
          <Tent size={32} className="text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]" strokeWidth={0.5} />
        </div>
        <div className="absolute top-3/4 left-1/2 bounce-stagger-3">
          <MapPin size={24} className="text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]" strokeWidth={0.5} />
        </div>
        <div className="absolute top-1/3 left-2/3 bounce-stagger-4">
          <Building2 size={40} className="text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]" strokeWidth={0.5} />
        </div>
      </div>
        ...
        <div className="text-center">
          <div className="inline-block mb-4">
            <div className="bg-[#FEB635]/20 backdrop-blur-sm rounded-full px-6 py-2 mb-6 border border-[#FEB635]/30">
              <span className="text-[#FEB635] font-semibold">Nuova avventura a Milano - 15 Maggio</span>
            </div>
          </div>
          <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl drop-shadow-[0_0_30px_rgba(255,255,255,0.2)]">
            ...
            <span className="block text-[#FEB635] mt-2 drop-shadow-[0_0_30px_rgba(254,182,53,0.3)]">ADTCUP</span>
          </h1>
          <p className="mt-6 max-w-md mx-auto text-base text-gray-300 sm:text-lg md:mt-8 md:text-xl md:max-w-3xl">
            Caccia al tesoro urbana, giochi divertenti e avventure indimenticabili.
            Unisciti alla community più coinvolgente d'Italia!
          </p>
          <div className="mt-8 max-w-md mx-auto sm:flex sm:justify-center md:mt-10">
            <div className="rounded-md shadow-[0_0_30px_rgba(254,182,53,0.3)]">
              <button
  className="w-full bg-[#FEB635] text-[#1B4D98] px-8 py-4 rounded-lg font-semibold text-lg transition transform duration-150 shadow-lg active:scale-95 active:shadow-sm"
>
  Inizia l'avventura
</button>
        ...
        <div className="mt-20 mb-32 grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="flex flex-col items-center text-white backdrop-blur-sm bg-white/5 rounded-xl p-6 border border-white/10 hover:border-white/20 animate-explore group transition-all duration-300">
            <div className="transform-gpu transition-transform duration-300 group-hover:scale-110">
              <MapPin size={48} className="text-[#FEB635] drop-shadow-[0_0_10px_rgba(254,182,53,0.5)]" strokeWidth={0.5} />
            </div>
          ...
          <div className="flex flex-col items-center text-white backdrop-blur-sm bg-white/5 rounded-xl p-6 border border-white/10 hover:border-white/20 animate-prize group transition-all duration-300">
            <div className="transform-gpu transition-transform duration-300 group-hover:scale-110">
              <Trophy size={48} className="text-[#FEB635] drop-shadow-[0_0_10px_rgba(254,182,53,0.5)]" strokeWidth={0.5} />
            </div>
          ...
          <div className="flex flex-col items-center text-white backdrop-blur-sm bg-white/5 rounded-xl p-6 border border-white/10 hover:border-white/20 animate-friends group transition-all duration-300">
            <div className="transform-gpu transition-transform duration-300 group-hover:scale-110">
              <Users size={48} className="text-[#FEB635] drop-shadow-[0_0_10px_rgba(254,182,53,0.5)]" strokeWidth={0.5} />
            </div>
